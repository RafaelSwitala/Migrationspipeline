...
| Changed files | Anzahl geaenderter Dateien |
| Commands run | Anzahl relevanter Commands |
| Re-runs | Anzahl Wiederholungen einer Phase |

## MET-005 Interpretation Notes

Bewertet wird nicht nur `PASS/FAIL`, sondern warum ein Agent besser oder schlechter abschneidet: fehlende Traceability, falsche Annahmen, unvollstaendige Tests, gute Mapping-Entscheidungen oder stabilere Fehlerdokumentation.
